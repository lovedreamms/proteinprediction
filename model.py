...
model = Sequential()
model.add(LSTM(4, return_sequences=True, input_shape=(X_train.shape[1], X_train.shape[2]),kernel_regularizer=l2(0.1),kernel_initializer='he_uniform'))
model.add(BatchNormalization())
model.add(LSTM(8, return_sequences=False,kernel_regularizer=l2(0.01),kernel_initializer='he_uniform'))
model.add(BatchNormalization())
